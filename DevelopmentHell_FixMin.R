...
pdf("~/UBC/GEA/pMax/writeUp/Plots/Figure2.fixmin.pdf",width = 5, height = 7)
print(Figure2)
dev.off()
...
ggsave("~/UBC/GEA/pMax/writeUp/Plots/Figure3.fixmin.pdf",config_plot,
       width = 8,
       height = 7)
...
ggsave("~/UBC/GEA/pMax/Analysis/convergenceConfigurations_n30_a0.05_t0.045_s.fixmin.pdf",config_plot,
       width = 14,
       height = 10)
...
ggsave("~/UBC/GEA/pMax/writeUp/Plots/Plot4.fixmin.pdf",
       genome_fdr_plot,
       width = 8,
       height = 4)
...
ggsave("~/UBC/GEA/pMax/Analysis/falsePositives_alphaAdapt.fixmin.pdf", alpha_adapt_FP_plot,
       width = 7, height = 5)
...
ggsave("~/UBC/GEA/pMax/Analysis/truePositives_alphaAdapt.fixmin.pdf", alpha_adapt_TP_plot,
       width = 7, height = 12)
...
ggsave("~/UBC/GEA/pMax/Analysis/null_distribution_histogram_n7.fixmin.pdf",
       width = 9.50,
       height = 6.50,
       units = "in")
...
ggsave("~/UBC/GEA/pMax/Analysis/null_distribution_histogram_n30.fixmin.pdf",
       width = 9.50,
       height = 6.50,
       units = "in")
